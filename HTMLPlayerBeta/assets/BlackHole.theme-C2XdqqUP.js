...
:root {
  ...
  --shadow-focus:
    0 0 0 2px hsla(0, 0%, 25%, 0.3), 0 1px 2px hsla(0, 0%, 0%, 0.1);
}
...
.dark {
  ...
  --shadow: 0 1px 2px hsla(0, 0%, 0%, 0.3), 0 3px 6px hsla(350, 85%, 60%, 0.1);
  --shadow-md:
...
`;export{n as default};
//# sourceMappingURL=BlackHole.theme-C2XdqqUP.js.map

...
:root {
  ...
  --shadow:
    0 1px 2px hsla(220, 20%, 5%, 0.05), 0 3px 6px hsla(220, 20%, 5%, 0.07);
  --shadow-md:
    0 1px 3px hsla(220, 20%, 5%, 0.05),
  ...
  --shadow-focus:
    0 0 0 2px hsla(200, 100%, 60%, 0.25), 0 1px 2px hsla(220, 20%, 5%, 0.05);
}
...
.dark {
  ...
  --shadow:
    0 1px 2px hsla(220, 20%, 0%, 0.1), 0 3px 6px hsla(220, 20%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(220, 20%, 0%, 0.1), 0 10px 15px -5px hsla(220, 20%, 0%, 0.1),
    0 20px 25px -5px hsla(220, 20%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(220, 20%, 0%, 0.1),
...
`;export{n as default};
//# sourceMappingURL=50Shades.theme-CigILfga.js.map

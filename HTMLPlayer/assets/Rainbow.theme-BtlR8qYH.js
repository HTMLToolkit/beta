...
:root {
  ...
  --themecolor-transparent: hsla(0, 100%, 50%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(240, 100%, 50%, 0.05), 0 3px 6px hsla(0, 100%, 50%, 0.07);
  --shadow-md:
    0 1px 3px hsla(240, 100%, 50%, 0.05),
  ...
  --shadow-focus:
    0 0 0 2px hsla(240, 100%, 50%, 0.3), 0 1px 2px hsla(300, 100%, 50%, 0.1);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(0, 100%, 65%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(240, 100%, 70%, 0.1), 0 3px 6px hsla(0, 100%, 70%, 0.15);
  --shadow-md:
    0 1px 3px hsla(240, 100%, 70%, 0.1),

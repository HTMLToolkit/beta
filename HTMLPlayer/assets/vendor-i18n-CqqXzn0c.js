const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./browser-ponyfill-cbhNWhYU.js","./vendor-react-qkC6yhPU.js"])))=>i.map(i=>d[i]);
import { r as P } from "./vendor-ui-WM1JXJ50.js";
import { s as nt } from "./vendor-uppy-DO2nUz3Y.js";
let Zt, Sn, Ut, mn, bn, $, vn;
let __tla = (async () => {
  const g = (s) => typeof s == "string", X = () => {
    let s, e;
    const t = new Promise((n, i) => {
      s = n, e = i;
    });
    return t.resolve = s, t.reject = e, t;
  }, xe = (s) => s == null ? "" : "" + s, it = (s, e, t) => {
    s.forEach((n) => {
      e[n] && (t[n] = e[n]);
    });
  }, st = /###/g, be = (s) => s && s.indexOf("###") > -1 ? s.replace(st, ".") : s, ve = (s) => !s || g(s), J = (s, e, t) => {
    ...
    for (const n in e) n !== "__proto__" && n !== "constructor" && (n in s ? g(s[n]) || s[n] instanceof String || g(e[n]) || e[n] instanceof String ? t && (s[n] = e[n]) : qe(s[n], e[n], t) : s[n] = e[n]);
    return s;
  }, K = (s) => s.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
  var at = {
    "&": "&amp;",
  ...
  const lt = (s) => g(s) ? s.replace(/[&<>"'\/]/g, (e) => at[e]) : s;
  class ut {
    constructor(e) {
  ...
  const ft = [
    ...
    "!",
    ";"
  ], ct = new ut(20), dt = (s, e, t) => {
    e = e || "", t = t || "";
    const n = ft.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
    ...
    return i;
  }, Q = (s) => s == null ? void 0 : s.replace("_", "-"), ht = {
    type: "logger",
    log(s) {
      this.output("log", s);
    },
  ...
  class ie {
    ...
    init(e, t = {}) {
      this.prefix = t.prefix || "i18next:", this.logger = e || ht, this.options = t, this.debug = t.debug;
    }
    log(...e) {
  ...
  class we extends oe {
    ...
    getResource(e, t, n, i = {}) {
      ...
      return !l && !t && !n && e.indexOf(".") > -1 && (e = a[0], t = a[1], n = a.slice(2).join(".")), l || !o || !g(n) ? l : fe((_b = (_a = this.data) == null ? void 0 : _a[e]) == null ? void 0 : _b[t], n, r);
    }
    addResource(e, t, n, i, r = {
      ...
      n && (a = a.concat(o ? n.split(o) : n)), e.indexOf(".") > -1 && (a = e.split("."), i = t, t = a[1]), this.addNamespaces(t), Se(this.data, a, i), r.silent || this.emit("added", e, t, n, i);
    }
    ...
    addResourceBundle(e, t, n, i, r, o = {
      ...
      o.skipCopy || (n = JSON.parse(JSON.stringify(n))), i ? qe(l, n, r) : l = {
        ...l,
        ...n
      }, Se(this.data, a, l), o.silent || this.emit("added", e, t, n);
    }
  ...
  const Be = /* @__PURE__ */ Symbol("i18next/PATH_KEY");
  function pt() {
    const s = [], e = /* @__PURE__ */ Object.create(null);
    let t;
    return e.get = (n, i) => {
      var _a;
      return (_a = t == null ? void 0 : t.revoke) == null ? void 0 : _a.call(t), i === Be ? s : (s.push(i), t = Proxy.revocable(n, e), t.proxy);
  ...
  const Oe = {}, ae = (s) => !g(s) && typeof s != "boolean" && typeof s != "number";
  class se extends oe {
    constructor(e, t = {}) {
      super(), it([
        "resourceStore",
    ...
    extractFromKey(e, t) {
      ...
      const o = n && e.indexOf(n) > -1, a = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !dt(e, n, i);
      if (o && !a) {
    ...
    translate(e, t, n) {
      ...
      if ((f == null ? void 0 : f.toLowerCase()) === "cimode") return p ? r ? {
        res: `${u}${c}${a}`,
        usedKey: a,
        exactUsedKey: a,
        usedLng: f,
      ...
      const y = (d == null ? void 0 : d.usedKey) || a, b = (d == null ? void 0 : d.exactUsedKey) || a, j = [
        "[object Number]",
        "[object Function]",
        "[object RegExp]"
      ], S = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays, C = !this.i18nFormat || this.i18nFormat.handleAsObject, O = i.count !== void 0 && !g(i.count), R = se.hasDefaultValue(i), N = O ? this.pluralResolver.getSuffix(f, i.count, i) : "", I = i.ordinal && O ? this.pluralResolver.getSuffix(f, i.count, {
        ordinal: false
      }) : "", G = O && !i.ordinal && i.count === 0, x = G && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${N}`] || i[`defaultValue${I}`] || i.defaultValue;
      let m = h;
      C && !h && R && (m = x);
      const v = ae(m), w = Object.prototype.toString.apply(m);
      if (C && m && v && j.indexOf(w) < 0 && !(g(S) && Array.isArray(m))) {
        if (!i.returnObjects && !this.options.returnObjects) {
          this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
          const L = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, m, {
            ...i,
            ns: l
          }) : `key '${a} (${this.language})' returned an object instead of string.`;
          return r ? (d.res = L, d.usedParams = this.getUsedParamsDetails(i), d) : L;
        }
        if (o) {
          const L = Array.isArray(m), k = L ? [] : {}, Z = L ? b : y;
          for (const T in m) if (Object.prototype.hasOwnProperty.call(m, T)) {
            const D = `${Z}${o}${T}`;
            R && !h ? k[T] = this.translate(D, {
              ...i,
              defaultValue: ae(x) ? x[T] : void 0,
              joinArrays: false,
              ns: l
            }) : k[T] = this.translate(D, {
              ...i,
              joinArrays: false,
              ns: l
            }), k[T] === D && (k[T] = m[T]);
      ...
      } else if (C && g(S) && Array.isArray(h)) h = h.join(S), h && (h = this.extendTranslation(h, e, i, n));
      else {
        let L = false, k = false;
        !this.isValidLookup(h) && R && (L = true, h = x), this.isValidLookup(h) || (k = true, h = a);
        const T = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && k ? void 0 : h, D = R && x !== h && this.options.updateMissing;
        if (k || L || D) {
          if (this.logger.log(D ? "updateKey" : "missingKey", f, u, a, D ? x : h), o) {
          ...
          if (this.options.saveMissingTo === "fallback" && ee && ee[0]) for (let E = 0; E < ee.length; E++) z.push(ee[E]);
          ...
          const me = (E, H, B) => {
            var _a;
            const ye = R && B !== h ? B : T;
            this.options.missingKeyHandler ? this.options.missingKeyHandler(E, u, H, ye, D, i) : ((_a = this.backendConnector) == null ? void 0 : _a.saveMissing) && this.backendConnector.saveMissing(E, u, H, ye, D, i), this.emit("missingKey", E, u, H, h);
          };
          this.options.saveMissing && (this.options.saveMissingPlurals && O ? z.forEach((E) => {
            const H = this.pluralResolver.getSuffixes(E, i);
            G && i[`defaultValue${this.options.pluralSeparator}zero`] && H.indexOf(`${this.options.pluralSeparator}zero`) < 0 && H.push(`${this.options.pluralSeparator}zero`), H.forEach((B) => {
              me([
                E
              ], a + B, i[`defaultValue${B}`] || x);
            });
          }) : me(z, a, x));
        }
        h = this.extendTranslation(h, e, i, d, n), k && h === a && this.options.appendNamespaceToMissingKey && (h = `${u}${c}${a}`), (k || L) && this.options.parseMissingKeyHandler && (h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${c}${a}` : a, L ? h : void 0, i));
      }
    ...
    extendTranslation(e, t, n, i, r) {
      ...
      return e != null && (a == null ? void 0 : a.length) && n.applyPostProcessor !== false && (e = ze.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
        i18nResolved: {
          ...i,
    ...
    resolve(e, t = {}) {
      ...
      return g(e) && (e = [
        ...
        f.forEach((b) => {
          var _a, _b;
          this.isValidLookup(n) || (a = b, !Oe[`${y[0]}-${b}`] && ((_a = this.utils) == null ? void 0 : _a.hasLoadedNamespace) && !((_b = this.utils) == null ? void 0 : _b.hasLoadedNamespace(a)) && (Oe[`${y[0]}-${b}`] = true, this.logger.warn(`key "${i}" for languages "${y.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), y.forEach((j) => {
            var _a2;
            if (this.isValidLookup(n)) return;
            o = j;
            const S = [
            ...
            if ((_a2 = this.i18nFormat) == null ? void 0 : _a2.addLookupKeys) this.i18nFormat.addLookupKeys(S, c, j, b, t);
            else {
              let O;
              p && (O = this.pluralResolver.getSuffix(j, t.count, t));
              const R = `${this.options.pluralSeparator}zero`, N = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
              if (p && (t.ordinal && O.indexOf(N) === 0 && S.push(c + O.replace(N, this.options.pluralSeparator)), S.push(c + O), d && S.push(c + R)), h) {
                const I = `${c}${this.options.contextSeparator || "_"}${t.context}`;
                S.push(I), p && (t.ordinal && O.indexOf(N) === 0 && S.push(I + O.replace(N, this.options.pluralSeparator)), S.push(I + O), d && S.push(I + R));
              }
            }
            let C;
            for (; C = S.pop(); ) this.isValidLookup(n) || (r = C, n = this.getResource(j, b, C, t));
          }));
        });
      }), {
        res: n,
  ...
  class gt {
    ...
    getRule(e, t = {}) {
      ...
      try {
        ...
        if (!Intl) return this.logger.error("No Intl support, please use an Intl polyfill!"), Ce;
    ...
    getSuffixes(e, t = {}) {
      let n = this.getRule(e, t);
      return n || (n = this.getRule("dev", t)), n ? n.resolvedOptions().pluralCategories.sort((i, r) => Pe[i] - Pe[r]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : [];
    }
    getSuffix(e, t, n = {}) {
  ...
  const Re = (s, e, t, n = ".", i = true) => {
    let r = ot(s, e, t);
    return !r && i && g(t) && (r = fe(s, t, n), r === void 0 && (r = fe(e, t, n))), r;
  }, le = (s) => s.replace(/\$/g, "$$$$");
  class ke {
    constructor(e = {}) {
      var _a;
    ...
    init(e = {}) {
      ...
      const { escape: t, escapeValue: n, useRawValueToEscape: i, prefix: r, prefixEscaped: o, suffix: a, suffixEscaped: l, formatSeparator: u, unescapeSuffix: c, unescapePrefix: f, nestingPrefix: p, nestingPrefixEscaped: d, nestingSuffix: h, nestingSuffixEscaped: y, nestingOptionsSeparator: b, maxReplaces: j, alwaysFormat: S } = e.interpolation;
      this.escape = t !== void 0 ? t : lt, this.escapeValue = n !== void 0 ? n : true, this.useRawValueToEscape = i !== void 0 ? i : false, this.prefix = r ? K(r) : o || "{{", this.suffix = a ? K(a) : l || "}}", this.formatSeparator = u || ",", this.unescapePrefix = c ? "" : f || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = p ? K(p) : d || K("$t("), this.nestingSuffix = h ? K(h) : y || K(")"), this.nestingOptionsSeparator = b || ",", this.maxReplaces = j || 1e3, this.alwaysFormat = S !== void 0 ? S : false, this.resetRegExp();
    }
    reset() {
    ...
    interpolate(e, t, n, i) {
      ...
      const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (d) => {
        if (d.indexOf(this.formatSeparator) < 0) {
          const j = Re(t, l, d, this.options.keySeparator, this.options.ignoreJSONStructure);
        ...
        const h = d.split(this.formatSeparator), y = h.shift().trim(), b = h.join(this.formatSeparator).trim();
        return this.format(Re(t, l, y, this.options.keySeparator, this.options.ignoreJSONStructure), b, n, {
          ...i,
          ...t,
          interpolationkey: y
        });
      ...
      return [
        ...
        {
          regex: this.regexp,
          safeValue: (d) => this.escapeValue ? le(this.escape(d)) : le(d)
        }
      ].forEach((d) => {
        for (a = 0; r = d.regex.exec(e); ) {
          const h = r[1].trim();
          if (o = u(h), o === void 0) if (typeof c == "function") {
            const b = c(e, r, i);
            o = g(b) ? b : "";
          } else if (i && Object.prototype.hasOwnProperty.call(i, h)) o = "";
          else if (f) {
            o = r[0];
            continue;
          } else this.logger.warn(`missed to pass in variable ${h} for interpolating ${e}`), o = "";
          else !g(o) && !this.useRawValueToEscape && (o = xe(o));
          const y = d.safeValue(o);
          if (e = e.replace(r[0], y), f ? (d.regex.lastIndex += o.length, d.regex.lastIndex -= r[0].length) : d.regex.lastIndex = 0, a++, a >= this.maxReplaces) break;
        }
      }), e;
    }
    nest(e, t, n = {}) {
      ...
      const a = (l, u) => {
        ...
        try {
          ...
          return this.logger.warn(`failed parsing options string in nesting for key ${l}`, y), `${l}${c}${p}`;
        }
      ...
      for (; i = this.nestingRegexp.exec(e); ) {
        ...
        g(r) || (r = xe(r)), r || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), r = ""), l.length && (r = l.reduce((c, f) => this.format(c, f, n.lng, {
          ...n,
  ...
  class xt {
    ...
    init(e, t = {
      ...
      const n = t.cacheInBuiltFormats ? $e : yt;
      this.formats = {
        number: n((i, r) => {
    ...
    format(e, t, n, i = {}) {
      ...
      return r.reduce((a, l) => {
        var _a;
        const { formatName: u, formatOptions: c } = mt(l);
        if (this.formats[u]) {
          let f = a;
          try {
            const p = ((_a = i == null ? void 0 : i.formatParams) == null ? void 0 : _a[i.interpolationkey]) || {}, d = p.locale || p.lng || i.locale || i.lng || n;
  ...
  class vt extends oe {
    ...
    queueLoad(e, t, n, i) {
      ...
      return e.forEach((u) => {
        ...
        t.forEach((f) => {
          const p = `${u}|${f}`;
          !n.reload && this.store.hasResourceBundle(u, f) ? this.state[p] = 2 : this.state[p] < 0 || (this.state[p] === 1 ? o[p] === void 0 && (o[p] = true) : (this.state[p] = 1, c = false, o[p] === void 0 && (o[p] = true), r[p] === void 0 && (r[p] = true), l[f] === void 0 && (l[f] = true)));
        }), c || (a[u] = true);
    ...
    loaded(e, t, n) {
      ...
      this.queue.forEach((l) => {
        rt(l.loaded, [
          r
        ], o), bt(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((u) => {
          a[u] || (a[u] = {});
          const c = l.loaded[u];
  ...
  class W extends oe {
    ...
    init(e = {}, t) {
      ...
      if (!this.options.isClone) {
        ...
        let u;
        this.modules.formatter ? u = this.modules.formatter : u = xt;
        const c = new Le(this.options);
        this.store = new we(this.options.resources, this.options);
        const f = this.services;
        f.logger = F, f.resourceStore = this.store, f.languageUtils = c, f.pluralResolver = new gt(c, {
        ...
        }, f.backendConnector = new vt(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", (d, ...h) => {
          this.emit(d, ...h);
    ...
    getFixedT(e, t, n) {
      const i = (r, o, ...a) => {
        ...
        let c;
        return l.keyPrefix && Array.isArray(r) ? c = r.map((f) => (typeof f == "function" && (f = ce(f, {
          ...this.options,
          ...o
        })), `${l.keyPrefix}${u}${f}`)) : (typeof r == "function" && (r = ce(r, {
          ...this.options,
          ...o
    ...
    dir(e) {
      ...
      const t = [
        ...
        "sam",
        "ckb"
      ], n = ((_b = this.services) == null ? void 0 : _b.languageUtils) || new Le(je());
    ...
    cloneInstance(e = {}, t = te) {
      ...
      if ((e.debug !== void 0 || e.prefix !== void 0) && (r.logger = r.logger.clone(e)), [
        ...
        r.store = new we(a, i), r.services.resourceStore = r.store;
      }
      return e.interpolation && (r.services.interpolator = new ke(i)), r.translator = new se(r.services, i), r.translator.on("*", (a, ...l) => {
        r.emit(a, ...l);
  ...
  const wt = (s, e, t, n) => {
    ...
    U(t) && Ne[t] || (U(t) && (Ne[t] = /* @__PURE__ */ new Date()), wt(s, e, t, n));
  }, Je = (s, e) => () => {
    ...
    s.loadNamespaces(e, Je(s, t));
  }, Te = (s, e, t, n) => {
    if (U(t) && (t = [
      t
    ]), s.options.preload && s.options.preload.indexOf(e) > -1) return de(s, t, n);
    t.forEach((i) => {
      s.options.ns.indexOf(i) < 0 && s.options.ns.push(i);
    }), s.loadLanguages(e, Je(s, n));
  }, Ot = (s, e, t = {}) => !e.languages || !e.languages.length ? (Xe(e, "NO_LANGUAGES", "i18n.languages were undefined or empty", {
  ...
  }), U = (s) => typeof s == "string", Lt = (s) => typeof s == "object" && s !== null, Pt = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, Ct = {
    "&amp;": "&",
    "&#38;": "&",
    "&lt;": "<",
    "&#60;": "<",
    ...
    "&#x2F;": "/",
    "&#47;": "/"
  }, Rt = (s) => Ct[s], kt = (s) => s.replace(Pt, Rt);
  let he = {
  ...
  let Ft, It, Dt;
  Ft = (s, e) => U(e) ? e : Lt(e) && U(e.defaultValue) ? e.defaultValue : Array.isArray(s) ? s[s.length - 1] : s;
  It = {
    t: Ft,
    ready: false
  };
  ...
  vn = (s, e = {}) => {
    var _a, _b, _c;
    const { i18n: t } = e, { i18n: n, defaultNS: i } = P.useContext(Qe) || {}, r = t || n || Nt();
    r && !r.reportNamespaces && (r.reportNamespaces = new Tt()), r || Xe(r, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
    const o = P.useMemo(() => {
      var _a2;
      return {
        ...jt(),
    ...
    const p = P.useRef(0), d = P.useCallback((x) => {
      if (!r) return Dt;
      const { bindI18n: m, bindI18nStore: v } = o, w = () => {
        p.current += 1, x();
      };
      return m && r.on(m, w), v && r.store.on(v, w), () => {
        m && m.split(" ").forEach((L) => r.off(L, w)), v && v.split(" ").forEach((L) => r.store.off(L, w));
      };
    }, [
      r,
      o
    ]), h = P.useRef(), y = P.useCallback(() => {
      if (!r) return It;
      const x = !!(r.isInitialized || r.initializedStoreOnce) && f.every((Z) => Ot(Z, r, o)), m = e.lng || r.language, v = p.current, w = h.current;
      if (w && w.ready === x && w.lng === m && w.keyPrefix === l && w.revision === v) return w;
      const k = {
      ...
      o,
      e.lng
    ]), [b, j] = P.useState(0), { t: S, ready: C } = nt.useSyncExternalStore(d, y, y);
    P.useEffect(() => {
      if (r && !C && !a) {
        const x = () => j((m) => m + 1);
        e.lng ? Te(r, e.lng, f, x) : de(r, f, x);
      }
    }, [
      r,
      e.lng,
    ...
    const O = r || {}, R = P.useRef(null), N = P.useRef(), I = (x) => {
      ...
      const x = O, m = x == null ? void 0 : x.language;
      let v = x;
      x && (R.current && R.current.__original === x ? N.current !== m ? (v = I(x), R.current = v, N.current = m) : v = R.current : (v = I(x), R.current = v, N.current = m));
      const w = [
        S,
        v,
        C
      ];
      return w.t = S, w.i18n = v, w.ready = C, w;
    }, [
      S,
      O,
      C,
    ...
    if (r && a && !C) throw new Promise((x) => {
      const m = () => x();
      e.lng ? Te(r, e.lng, f, m) : de(r, f, m);
    });
    return G;
  };
  Sn = function({ i18n: s, defaultNS: e, children: t }) {
    const n = P.useMemo(() => ({
      i18n: s,
      defaultNS: e
    }), [
    ...
    return P.createElement(Qe.Provider, {
      value: n
    }, t);
  };
  let At, Ht, Fe;
  ...
  Ut = function(e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      i = u(t.map((c) => {
        if (c = Ht(c, n), c in Fe) return;
        Fe[c] = true;
        const f = c.endsWith(".css"), p = f ? '[rel="stylesheet"]' : "";
        if (n) for (let h = o.length - 1; h >= 0; h--) {
          const y = o[h];
          if (y.href === c && (!f || y.rel === "stylesheet")) return;
        }
        else if (document.querySelector(`link[href="${c}"]${p}`)) return;
        const d = document.createElement("link");
        if (d.rel = f ? "stylesheet" : At, f || (d.as = "script"), d.crossOrigin = "", d.href = c, l && d.setAttribute("nonce", l), document.head.appendChild(d), f) return new Promise((h, y) => {
          d.addEventListener("load", h), d.addEventListener("error", () => y(new Error(`Unable to preload CSS for ${c}`)));
        });
      }));
    }
    function r(o) {
  ...
  function Kt(s) {
    return Mt(s) ? s : Promise.resolve(s);
  }
  function Ie(s, e) {
    var t = Object.keys(s);
  ...
  function De(s) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      e % 2 ? Ie(Object(t), true).forEach(function(n) {
        Vt(s, n, t[n]);
  ...
  function Vt(s, e, t) {
    return (e = _t(e)) in s ? Object.defineProperty(s, e, {
      value: t,
      enumerable: true,
      configurable: true,
      writable: true
  ...
  var Y;
  Ye() && (typeof global < "u" && global.XMLHttpRequest ? Y = global.XMLHttpRequest : typeof window < "u" && window.XMLHttpRequest && (Y = window.XMLHttpRequest));
  var re;
  ...
  if (!A && !Y && !re) try {
    Ut(() => import("./browser-ponyfill-cbhNWhYU.js").then((s) => s.b), __vite__mapDeps([0,1]), import.meta.url).then(function(s) {
      A = s.default;
    }).catch(function() {
    });
  } catch {
  ...
  var ge = function(e, t) {
  ...
  }, He = false, zt = function(e, t, n, i) {
    e.queryStringParams && (t = ge(t, e.queryStringParams));
    var r = De({}, typeof e.customHeaders == "function" ? e.customHeaders() : e.customHeaders);
    ...
    var o = typeof e.requestOptions == "function" ? e.requestOptions(n) : e.requestOptions, a = De({
      method: n ? "POST" : "GET",
      body: n ? e.stringify(n) : void 0,
      headers: r
    }, He ? {} : o), l = typeof e.alternateFetch == "function" && e.alternateFetch.length >= 1 ? e.alternateFetch : void 0;
    try {
      Ae(t, a, i, l);
    } catch (u) {
    ...
    n && M(n) === "object" && (n = ge("", n).slice(1)), e.queryStringParams && (t = ge(t, e.queryStringParams));
    try {
    ...
    }, A && t.indexOf("file:") !== 0) return zt(e, t, n, i);
    if (Ye() || typeof ActiveXObject == "function") return Bt(e, t, n, i);
  ...
  function ue(s) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e] != null ? arguments[e] : {};
      e % 2 ? Ue(Object(t), true).forEach(function(n) {
        Ge(s, n, t[n]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(t)) : Ue(Object(t)).forEach(function(n) {
        Object.defineProperty(s, n, Object.getOwnPropertyDescriptor(t, n));
      });
    }
    return s;
  ...
  function Wt(s, e) {
    for (var t = 0; t < e.length; t++) {
      var n = e[t];
      n.enumerable = n.enumerable || false, n.configurable = true, "value" in n && (n.writable = true), Object.defineProperty(s, Ze(n.key), n);
    }
  }
  function Qt(s, e, t) {
    return e && Wt(s.prototype, e), Object.defineProperty(s, "prototype", {
      writable: false
    }), s;
  }
  function Ge(s, e, t) {
    return (e = Ze(e)) in s ? Object.defineProperty(s, e, {
      value: t,
      enumerable: true,
      configurable: true,
      writable: true
  ...
  Zt = (function() {
    function s(e) {
      ...
      Jt(this, s), this.services = e, this.options = t, this.allOptions = n, this.type = "backend", this.init(e, t, n);
    }
    return Qt(s, [
      {
        key: "init",
        value: function(t) {
          ...
          if (this.services = t, this.options = ue(ue(ue({}, Gt()), this.options || {}), i), this.allOptions = r, this.services && this.options.reloadInterval) {
      ...
      },
      {
        ...
        value: function(t, n, i, r, o) {
          ...
          typeof this.options.loadPath == "function" && (l = this.options.loadPath(t, i)), l = Kt(l), l.then(function(u) {
            if (!u) return o(null, {});
        ...
        value: function(t, n, i, r) {
          ...
          this.options.request(this.options, t, u, function(c, f) {
            ...
            if (!f && c && c.message) {
              ...
              if (d) return n("failed loading " + t + ": " + c.message, true);
            }
        ...
        value: function(t, n, i, r, o) {
          ...
          if (this.options.addPath) {
            ...
            t.forEach(function(p) {
              ...
              a.options.request(a.options, h, l, function(y, b) {
                u += 1, c.push(y), f.push(b), u === t.length && typeof o == "function" && o(c, f);
              });
            });
          }
        }
  ...
  Zt.type = "backend";
  const { slice: en, forEach: tn } = [];
  function nn(s) {
    return tn.call(en.call(arguments, 1), (e) => {
  ...
  const Me = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, rn = function(s, e) {
    ...
    if (n.domain) {
      if (!Me.test(n.domain)) throw new TypeError("option domain is invalid");
      r += `; Domain=${n.domain}`;
    }
    if (n.path) {
      if (!Me.test(n.path)) throw new TypeError("option path is invalid");
      r += `; Path=${n.path}`;
    }
    if (n.expires) {
    ...
    create(s, e, t, n) {
      ...
      t && (i.expires = /* @__PURE__ */ new Date(), i.expires.setTime(i.expires.getTime() + t * 60 * 1e3)), n && (i.domain = n), document.cookie = rn(s, e, i);
    },
    read(s) {
  ...
  var un = {
    ...
    lookup(s) {
      ...
      if (e && Ve()) return window.localStorage.getItem(e) || void 0;
    },
    cacheUserLanguage(s, e) {
      let { lookupLocalStorage: t } = e;
      t && Ve() && window.localStorage.setItem(t, s);
    }
  };
  let _ = null;
  const _e = () => {
  ...
  var fn = {
    ...
    lookup(s) {
      ...
      if (e && _e()) return window.sessionStorage.getItem(e) || void 0;
    },
    cacheUserLanguage(s, e) {
      let { lookupSessionStorage: t } = e;
      t && _e() && window.sessionStorage.setItem(t, s);
    }
  }, cn = {
    name: "navigator",
    lookup(s) {
  ...
  mn = class {
    ...
    init() {
      ...
      this.services = e, this.options = nn(t, this.options || {}, gn()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = (i) => i.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(on), this.addDetector(an), this.addDetector(un), this.addDetector(fn), this.addDetector(cn), this.addDetector(dn), this.addDetector(hn), this.addDetector(pn), this.addDetector(ln);
    }
    addDetector(e) {
    ...
    detect() {
      ...
      }), t = t.filter((n) => n != null && !sn(n)).map((n) => this.options.convertDetectedLanguage(n)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null;
    }
    cacheUserLanguage(e) {

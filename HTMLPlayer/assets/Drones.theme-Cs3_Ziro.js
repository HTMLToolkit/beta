...
:root {
  ...
  --themecolor-transparent: hsla(262, 90%, 68%, 0.5);
  ...
  --foreground-strong: hsl(256, 30%, 10%);
  --foreground-stronger: hsl(256, 40%, 5%);
  --foreground-muted: hsl(256, 20%, 40%);
  --foreground-subtle: hsl(256, 15%, 60%);
...
.dark {
  ...
  --themecolor-transparent: hsla(262, 75%, 55%, 0.5);

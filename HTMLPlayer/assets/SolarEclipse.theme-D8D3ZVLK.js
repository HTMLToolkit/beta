...
:root {
  ...
  --themecolor-transparent: hsla(16, 100%, 50%, 0.5);
  ...
  --border: hsl(40, 20%, 85%);
  --shadow:
    0 1px 2px hsla(16, 100%, 50%, 0.1), 0 3px 6px hsla(38, 100%, 50%, 0.12);
  --shadow-md:
    0 1px 3px hsla(16, 100%, 50%, 0.1),
  ...
  --shadow-focus:
    0 0 0 2px hsla(38, 100%, 50%, 0.4), 0 0 12px hsla(60, 100%, 50%, 0.3);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(16, 100%, 60%, 0.5);
  ...
  /* Shadows */
  --border: hsl(20, 15%, 10%);
  --shadow: 0 1px 2px hsla(0, 0%, 0%, 0.4), 0 3px 6px hsla(16, 100%, 60%, 0.2);
  --shadow-md:
    0 1px 3px hsla(0, 0%, 0%, 0.4), 0 10px 15px -5px hsla(0, 0%, 0%, 0.3),
    0 20px 25px -5px hsla(38, 100%, 60%, 0.1);
  --shadow-lg:
    0 1px 3px hsla(0, 0%, 0%, 0.4), 0 20px 25px -5px hsla(0, 0%, 0%, 0.35),

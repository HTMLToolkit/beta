...
:root {
  ...
  --themecolor-transparent: hsla(180, 100%, 50%, 0.5);
  ...
  --foreground-strong: hsl(0, 0%, 10%);
  --foreground-stronger: hsl(0, 0%, 5%);
  --foreground-muted: hsl(0, 0%, 21%);
  ...
  --shadow:
    0 1px 2px hsla(180, 100%, 50%, 0.1), 0 3px 6px hsla(300, 100%, 50%, 0.07);
  --shadow-md:
    0 1px 3px hsla(180, 100%, 50%, 0.1),
  ...
  --shadow-focus:
    0 0 0 2px hsla(180, 100%, 50%, 0.4), 0 1px 2px hsla(300, 100%, 50%, 0.1);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(180, 100%, 60%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(180, 100%, 60%, 0.2), 0 3px 6px hsla(300, 100%, 60%, 0.15);
  --shadow-md:
    0 1px 3px hsla(180, 100%, 60%, 0.2),

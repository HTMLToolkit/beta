...
:root {
  ...
  --shadow-focus:
    0 0 0 2px hsla(215, 70%, 50%, 0.25), 0 1px 2px hsla(220, 15%, 5%, 0.05);
}
...
.dark {
  ...
  --shadow:
    0 1px 2px hsla(220, 15%, 0%, 0.1), 0 3px 6px hsla(220, 15%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(220, 15%, 0%, 0.1), 0 10px 15px -5px hsla(220, 15%, 0%, 0.1),
    0 20px 25px -5px hsla(220, 15%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(220, 15%, 0%, 0.1),
...
`;export{r as default};
//# sourceMappingURL=Blue.theme-nSrWNgNx.js.map

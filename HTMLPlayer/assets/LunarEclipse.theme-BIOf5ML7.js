...
:root {
  ...
  --themecolor-transparent: hsla(15, 45%, 25%, 0.5);
  ...
  --border: hsl(15, 20%, 85%);
  --shadow:
    0 1px 2px hsla(15, 45%, 25%, 0.08), 0 3px 6px hsla(0, 35%, 45%, 0.1);
  --shadow-md:
    0 1px 3px hsla(15, 45%, 25%, 0.08),
    0 10px 15px -5px hsla(0, 35%, 45%, 0.08),
    0 20px 25px -5px hsla(0, 50%, 60%, 0.06);
  --shadow-lg:
    0 1px 3px hsla(15, 45%, 25%, 0.08), 0 20px 25px -5px hsla(0, 35%, 45%, 0.1),
    0 30px 40px -5px hsla(0, 50%, 60%, 0.08);
  --shadow-focus:
    0 0 0 2px hsla(15, 55%, 35%, 0.3), 0 0 8px hsla(0, 50%, 60%, 0.2);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(15, 60%, 40%, 0.5);
  ...
  /* Shadows */
  --border: hsl(15, 20%, 12%);
  --shadow: 0 1px 2px hsla(0, 0%, 0%, 0.3), 0 3px 6px hsla(15, 60%, 40%, 0.15);
  --shadow-md:
    0 1px 3px hsla(0, 0%, 0%, 0.3), 0 10px 15px -5px hsla(0, 0%, 0%, 0.2),
    0 20px 25px -5px hsla(0, 60%, 55%, 0.1);
  --shadow-lg:
    0 1px 3px hsla(0, 0%, 0%, 0.3), 0 20px 25px -5px hsla(0, 0%, 0%, 0.25),

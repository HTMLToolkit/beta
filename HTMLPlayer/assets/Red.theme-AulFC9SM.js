...
:root {
  ...
  --themecolor-transparent: hsla(0, 80%, 35%, 0.5);
  ...
  --shadow-md:
    0 1px 3px hsla(0, 15%, 5%, 0.05), 0 10px 15px -5px hsla(0, 15%, 5%, 0.05),
    0 20px 25px -5px hsla(0, 15%, 5%, 0.04);
  --shadow-lg:
    0 1px 3px hsla(0, 15%, 5%, 0.05), 0 20px 25px -5px hsla(0, 15%, 5%, 0.07),
    0 30px 40px -5px hsla(0, 15%, 5%, 0.05);
  --shadow-focus:
    0 0 0 2px hsla(0, 75%, 45%, 0.25), 0 1px 2px hsla(0, 15%, 5%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(0, 75%, 20%, 0.5);
  ...
  --shadow-md:
    0 1px 3px hsla(0, 55%, 0%, 0.1), 0 10px 15px -5px hsla(0, 55%, 0%, 0.1),
    0 20px 25px -5px hsla(0, 55%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(0, 55%, 0%, 0.1), 0 20px 25px -5px hsla(0, 55%, 0%, 0.15),

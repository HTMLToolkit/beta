import { E as w, j as f, h as S, Q as h, R as T, S as E, m as I, V as $, B as z, W as D, J as N } from "./vendor-audio-DkF9nV6x.js";
...
class U {
  ...
  async parseContainer(a, t, u) {
    ...
    for (; this.tokenizer.position < t; ) {
      ...
      else r.id === 236 ? await this.tokenizer.ignore(r.len) : (g(`parseEbml: parent=${x(a)}, unknown child: id=${r.id.toString(16)} at position=${s}`), await this.tokenizer.ignore(r.len));
    }
    return o;
  }
        ...
        case 374648427:
          {
            ...
            if (s == null ? void 0 : s.entries) {
              s.entries.forEach((i) => {
                const m = { codecName: i.codecID.replace("A_", "").replace("V_", ""), codecSettings: i.codecSettings, flagDefault: i.flagDefault, flagLacing: i.flagLacing, flagEnabled: i.flagEnabled, language: i.language, name: i.name, type: i.trackType, audio: i.audio, video: i.video };
        ...
        case 307544935:
          {
            ...
            await Promise.all(s.tag.map(async (n) => {
              const i = n.target, m = (i == null ? void 0 : i.targetTypeValue) ? D[i.targetTypeValue] : (i == null ? void 0 : i.targetType) ? i.targetType : "track";

...
:root {
  ...
  --themecolor-transparent: hsla(15, 100%, 60%, 0.5);
  ...
  /* Shadows */
  --shadow:
    0 1px 2px hsla(15, 100%, 0%, 0.05), 0 3px 6px hsla(15, 100%, 0%, 0.07);
  --shadow-md:
    0 1px 3px hsla(15, 100%, 0%, 0.05),
  ...
  --shadow-focus:
    0 0 0 2px hsla(20, 90%, 55%, 0.25), 0 1px 2px hsla(15, 100%, 0%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(290, 66%, 25%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(290, 50%, 0%, 0.1), 0 3px 6px hsla(290, 50%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(290, 50%, 0%, 0.1), 0 10px 15px -5px hsla(290, 50%, 0%, 0.1),
    0 20px 25px -5px hsla(290, 50%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(290, 50%, 0%, 0.1),

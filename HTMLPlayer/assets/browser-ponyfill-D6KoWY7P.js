import { c as R, g as z } from "./vendor-react-C6Febm84.js";
function $(w, d) {
  for (var b = 0; b < d.length; b++) {
    const y = d[b];
    if (typeof y != "string" && !Array.isArray(y)) {
      for (const h in y) if (h !== "default" && !(h in w)) {
        const p = Object.getOwnPropertyDescriptor(y, h);
        p && Object.defineProperty(w, h, p.get ? p : { enumerable: true, get: () => y[h] });
      }
    }
  }
...
function X() {
  return U || (U = 1, (function(w, d) {
    ...
    (function(p) {
      (function(u) {
        var a = typeof p < "u" && p || typeof self < "u" && self || typeof a < "u" && a, f = { searchParams: "URLSearchParams" in a, iterable: "Symbol" in a && "iterator" in Symbol, blob: "FileReader" in a && "Blob" in a && (function() {
          try {
        ...
        if (f.arrayBuffer) var F = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], I = ArrayBuffer.isView || function(e) {
        ...
        function m(e, t) {
          ...
          if (e instanceof m) {
            ...
            this.url = e.url, this.credentials = e.credentials, t.headers || (this.headers = new s(e.headers)), this.method = e.method, this.mode = e.mode, this.signal = e.signal, !r && e._bodyInit != null && (r = e._bodyInit, e.bodyUsed = true);
          } else this.url = String(e);
          if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new s(t.headers)), this.method = C(t.method || this.method || "GET"), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && r) throw new TypeError("Body not allowed for GET or HEAD requests");
          if (this._initBody(r), (this.method === "GET" || this.method === "HEAD") && (t.cache === "no-store" || t.cache === "no-cache")) {
            var n = /([?&])_=[^&]*/;
            if (n.test(this.url)) this.url = this.url.replace(n, "$1_=" + (/* @__PURE__ */ new Date()).getTime());
            else {
              var i = /\?/;
...
`) === 0 ? n.substr(1, n.length) : n;
        ...
        x.call(c.prototype), c.prototype.clone = function() {
          return new c(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new s(this.headers), url: this.url });
        }, c.error = function() {
        ...
        function O(e, t) {
          return new Promise(function(r, n) {
            ...
            o.open(i.method, V(i.url), true), i.credentials === "include" ? o.withCredentials = true : i.credentials === "omit" && (o.withCredentials = false), "responseType" in o && (f.blob ? o.responseType = "blob" : f.arrayBuffer && i.headers.get("Content-Type") && i.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (o.responseType = "arraybuffer")), t && typeof t.headers == "object" && !(t.headers instanceof s) ? Object.getOwnPropertyNames(t.headers).forEach(function(l) {
        ...
        return O.polyfill = true, a.fetch || (a.fetch = O, a.Headers = s, a.Request = m, a.Response = c), u.Headers = s, u.Request = m, u.Response = c, u.fetch = O, u;
      })({});
...
var j = X();
const J = z(j), Q = $({ __proto__: null, default: J }, [j]);
export {
  Q as b
};

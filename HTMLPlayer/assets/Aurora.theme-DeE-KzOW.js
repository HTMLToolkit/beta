...
:root {
  ...
  --themegradient: linear-gradient(
    135deg in oklab,
    color-mix(in oklab, #00ff87 70%, #ff0080 30%),
    color-mix(in oklab, #0080ff 60%, #ff4000 40%)
  );
  ...
  --foreground: light-dark(
    color-mix(in oklab, #1a1a2e 90%, #00ff87 10%),
    color-mix(in oklab, #f0f8ff 95%, #00ff87 5%)
  );
  --foreground-strong: color-mix(in oklch, #2a2a4e 80%, #ffffff 20%);
  --foreground-stronger: color-mix(in oklch, #3a3a6e 70%, #ffffff 30%);
  --foreground-muted: color-mix(in oklch, #2a2a5e 80%, #ffffff 20%);
  --foreground-subtle: color-mix(in oklch, #6a6aae 40%, #ffffff 60%);

  /* Background */
  --background: conic-gradient(
    from 0deg at 50% 100%,
    color-mix(in oklab, #fafcff 95%, #00ff87 5%),
    color-mix(in oklab, #f8faff 95%, #0080ff 5%)
  );
  ...
  --primary-transparent-1: color-mix(
    in oklab,
    transparent 90%,
    oklch(70% 0.15 180)
  );
  --primary-transparent-2: color-mix(
    in oklab,
    transparent 85%,
    oklch(70% 0.15 180)
  );
  --primary-transparent-3: color-mix(
    in oklab,
    transparent 80%,
    oklch(70% 0.15 180)
  );
  --primary-transparent-4: color-mix(
    in oklab,
    transparent 70%,
    oklch(70% 0.15 180)
  );
  --primary-transparent-5: color-mix(
    in oklab,
    transparent 65%,
    oklch(70% 0.15 180)
  );
  ...
  --primary-border-strong: color-mix(
    in oklab,
    transparent 60%,
    oklch(70% 0.15 180)
  );
  --primary-border-stronger: color-mix(
    in oklab,
    transparent 50%,
    oklch(70% 0.15 180)
  );
  --primary-border-active: color-mix(
    in oklab,
    transparent 40%,
    oklch(70% 0.15 180)
  );
  ...
  --favorite-transparent-1: color-mix(
    in oklab,
    transparent 85%,
    oklch(70% 0.2 30)
  );
  --favorite-transparent-2: color-mix(
    in oklab,
    transparent 75%,
    oklch(70% 0.2 30)
  );
  ...
  --danger-transparent-1: color-mix(
    in oklab,
    transparent 85%,
    oklch(65% 0.22 15)
  );
  --danger-transparent-2: color-mix(
    in oklab,
    transparent 75%,
    oklch(65% 0.22 15)
  );
  ...
  --albumart-gradient: conic-gradient(
    from 45deg,
    color-mix(in oklab, #00ff87 80%, #ffffff 20%) 0%,
    color-mix(in oklab, #0080ff 80%, #ffffff 20%) 100%
  );
  ...
  --shadow-md:
    0 1px 3px color-mix(in oklab, transparent 95%, #00ff87),
  ...
  --shadow-focus:
    0 0 0 2px color-mix(in oklab, transparent 75%, oklch(70% 0.15 180)),
    0 1px 2px color-mix(in oklab, transparent 95%, #00ff87);
}
...
.dark {
  ...
  --themegradient: linear-gradient(
    135deg in oklab,
    color-mix(in oklab, #003d1a 80%, #00ff87 20%),
    color-mix(in oklab, #001a33 80%, #0080ff 20%)
  );
  ...
  --background: conic-gradient(
    from 180deg at 50% 0%,
    color-mix(in oklab, #0a0f1a 95%, #00ff87 5%),
    color-mix(in oklab, #0f0a1a 95%, #0080ff 5%)
  );
  ...
  --danger-border: color-mix(in oklab, transparent 70%, oklch(70% 0.2 20));
  ...
  --albumart-gradient: conic-gradient(
    from 225deg,
    color-mix(in oklab, #003d1a 80%, #000000 20%) 0%,
    color-mix(in oklab, #001a33 80%, #000000 20%) 100%
  );
  ...
  --shadow-md:
    0 1px 3px color-mix(in oklab, transparent 90%, #000000),
...
`;export{n as default};
//# sourceMappingURL=Aurora.theme-DeE-KzOW.js.map

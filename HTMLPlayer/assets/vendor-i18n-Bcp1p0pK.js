const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-ponyfill-cbhNWhYU.js","assets/vendor-react-qkC6yhPU.js"])))=>i.map(i=>d[i]);
import { r as P } from "./vendor-ui-WM1JXJ50.js";
import { s as nt } from "./vendor-uppy-DO2nUz3Y.js";
let Zt, Sn, rt, mn, xn, j, vn;
let __tla = (async () => {
  let it, st, be, g, X, xe, ot, at, ve, Se, J, we, lt, ne, ut, qe, K;
  it = "modulepreload";
  st = function(s) {
  ...
  rt = function(e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      i = l(t.map((u) => {
        if (u = st(u), u in be) return;
        be[u] = true;
        const c = u.endsWith(".css"), f = c ? '[rel="stylesheet"]' : "";
        if (document.querySelector(`link[href="${u}"]${f}`)) return;
        const d = document.createElement("link");
        if (d.rel = c ? "stylesheet" : it, c || (d.as = "script"), d.crossOrigin = "", d.href = u, a && d.setAttribute("nonce", a), document.head.appendChild(d), c) return new Promise((h, p) => {
  ...
  at = /###/g;
  ve = (s) => s && s.indexOf("###") > -1 ? s.replace(at, ".") : s;
  Se = (s) => !s || g(s);
  J = (s, e, t) => {
  ...
  const ct = (s) => g(s) ? s.replace(/[&<>"'\/]/g, (e) => ft[e]) : s;
  class dt {
    constructor(e) {
  ...
  const ht = [
    ...
    "!",
    ";"
  ], pt = new dt(20), gt = (s, e, t) => {
    e = e || "", t = t || "";
    const n = ht.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
    if (n.length === 0) return true;
    const i = pt.getRegExp(`(${n.map((o) => o === "?" ? "\\?" : o).join("|")})`);
    let r = !i.test(s);
    if (!r) {
      const o = s.indexOf(t);
    ...
    return i;
  }, Q = (s) => s == null ? void 0 : s.replace("_", "-"), mt = {
    type: "logger",
    log(s) {
      this.output("log", s);
    },
  ...
  class ie {
    ...
    init(e, t = {}) {
      this.prefix = t.prefix || "i18next:", this.logger = e || mt, this.options = t, this.debug = t.debug;
    }
    log(...e) {
  ...
  class Oe extends oe {
    ...
    addResource(e, t, n, i, r = {
      ...
      n && (a = a.concat(o ? n.split(o) : n)), e.indexOf(".") > -1 && (a = e.split("."), i = t, t = a[1]), this.addNamespaces(t), we(this.data, a, i), r.silent || this.emit("added", e, t, n, i);
    }
    ...
    addResourceBundle(e, t, n, i, r, o = {
      ...
      o.skipCopy || (n = JSON.parse(JSON.stringify(n))), i ? qe(l, n, r) : l = {
        ...l,
        ...n
      }, we(this.data, a, l), o.silent || this.emit("added", e, t, n);
    }
  ...
  const Le = {}, ae = (s) => !g(s) && typeof s != "boolean" && typeof s != "number";
  class se extends oe {
    constructor(e, t = {}) {
      super(), ot([
        "resourceStore",
    ...
    extractFromKey(e, t) {
      ...
      const o = n && e.indexOf(n) > -1, a = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !gt(e, n, i);
      if (o && !a) {
    ...
    translate(e, t, n) {
      ...
      const b = (h == null ? void 0 : h.usedKey) || a, x = (h == null ? void 0 : h.exactUsedKey) || a, $ = [
        ...
        ordinal: false
      }) : "", G = O && !i.ordinal && i.count === 0, y = G && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${N}`] || i[`defaultValue${I}`] || i.defaultValue;
      let m = p;
      C && !p && R && (m = y);
      const v = ae(m), w = Object.prototype.toString.apply(m);
      if (C && m && v && $.indexOf(w) < 0 && !(g(S) && Array.isArray(m))) {
      ...
      } else if (C && g(S) && Array.isArray(p)) p = p.join(S), p && (p = this.extendTranslation(p, e, i, n));
      else {
        let L = false, k = false;
        !this.isValidLookup(p) && R && (L = true, p = y), this.isValidLookup(p) || (k = true, p = a);
        const T = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && k ? void 0 : p, D = R && y !== p && this.options.updateMissing;
        if (k || L || D) {
          ...
          const me = (E, H, B) => {
            var _a;
            const ye = R && B !== p ? B : T;
            this.options.missingKeyHandler ? this.options.missingKeyHandler(E, u, H, ye, D, i) : ((_a = this.backendConnector) == null ? void 0 : _a.saveMissing) && this.backendConnector.saveMissing(E, u, H, ye, D, i), this.emit("missingKey", E, u, H, p);
          };
        ...
        p = this.extendTranslation(p, e, i, h, n), k && p === a && this.options.appendNamespaceToMissingKey && (p = `${u}${c}${a}`), (k || L) && this.options.parseMissingKeyHandler && (p = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${c}${a}` : a, L ? p : void 0, i));
      }
    ...
    resolve(e, t = {}) {
      ...
      return g(e) && (e = [
        ...
        f.forEach((x) => {
          var _a, _b;
          this.isValidLookup(n) || (a = x, !Le[`${b[0]}-${x}`] && ((_a = this.utils) == null ? void 0 : _a.hasLoadedNamespace) && !((_b = this.utils) == null ? void 0 : _b.hasLoadedNamespace(a)) && (Le[`${b[0]}-${x}`] = true, this.logger.warn(`key "${i}" for languages "${b.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), b.forEach(($) => {
            var _a2;
            if (this.isValidLookup(n)) return;
            o = $;
            const S = [
            ...
            if ((_a2 = this.i18nFormat) == null ? void 0 : _a2.addLookupKeys) this.i18nFormat.addLookupKeys(S, c, $, x, t);
            else {
              let O;
              ...
              if (d && (t.ordinal && O.indexOf(N) === 0 && S.push(c + O.replace(N, this.options.pluralSeparator)), S.push(c + O), h && S.push(c + R)), p) {
                const I = `${c}${this.options.contextSeparator || "_"}${t.context}`;
                S.push(I), d && (t.ordinal && O.indexOf(N) === 0 && S.push(I + O.replace(N, this.options.pluralSeparator)), S.push(I + O), h && S.push(I + R));
              }
            }
            let C;
            for (; C = S.pop(); ) this.isValidLookup(n) || (r = C, n = this.getResource($, x, C, t));
          }));
        });
      }), {
        res: n,
  ...
  class bt {
    ...
    getSuffixes(e, t = {}) {
      let n = this.getRule(e, t);
      return n || (n = this.getRule("dev", t)), n ? n.resolvedOptions().pluralCategories.sort((i, r) => Ce[i] - Ce[r]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : [];
    }
    getSuffix(e, t, n = {}) {
  ...
  class je {
    ...
    init(e = {}) {
      ...
      const { escape: t, escapeValue: n, useRawValueToEscape: i, prefix: r, prefixEscaped: o, suffix: a, suffixEscaped: l, formatSeparator: u, unescapeSuffix: c, unescapePrefix: f, nestingPrefix: d, nestingPrefixEscaped: h, nestingSuffix: p, nestingSuffixEscaped: b, nestingOptionsSeparator: x, maxReplaces: $, alwaysFormat: S } = e.interpolation;
      this.escape = t !== void 0 ? t : ct, this.escapeValue = n !== void 0 ? n : true, this.useRawValueToEscape = i !== void 0 ? i : false, this.prefix = r ? K(r) : o || "{{", this.suffix = a ? K(a) : l || "}}", this.formatSeparator = u || ",", this.unescapePrefix = c ? "" : f || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = d ? K(d) : h || K("$t("), this.nestingSuffix = p ? K(p) : b || K(")"), this.nestingOptionsSeparator = x || ",", this.maxReplaces = $ || 1e3, this.alwaysFormat = S !== void 0 ? S : false, this.resetRegExp();
    }
    reset() {
    ...
    interpolate(e, t, n, i) {
      ...
      const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (h) => {
        if (h.indexOf(this.formatSeparator) < 0) {
          const $ = ke(t, l, h, this.options.keySeparator, this.options.ignoreJSONStructure);
        ...
        return this.format(ke(t, l, b, this.options.keySeparator, this.options.ignoreJSONStructure), x, n, {
          ...i,
          ...t,
          interpolationkey: b
        });
  ...
  class St {
    ...
    init(e, t = {
      ...
      const n = t.cacheInBuiltFormats ? $e : vt;
      this.formats = {
        number: n((i, r) => {
    ...
    format(e, t, n, i = {}) {
      ...
      return r.reduce((a, l) => {
        var _a;
        const { formatName: u, formatOptions: c } = xt(l);
        if (this.formats[u]) {
          let f = a;
          try {
  ...
  class Ot extends oe {
    ...
    loaded(e, t, n) {
      ...
      this.queue.forEach((l) => {
        lt(l.loaded, [
          r
        ], o), wt(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((u) => {
          a[u] || (a[u] = {});
          const c = l.loaded[u];
  ...
  class W extends oe {
    constructor(e = {}, t) {
      if (super(), this.options = Ne(e), this.services = {}, this.logger = F, this.modules = {
        external: []
    ...
    init(e = {}, t) {
      ...
      if (!this.options.isClone) {
        ...
        let u;
        this.modules.formatter ? u = this.modules.formatter : u = St;
        const c = new Pe(this.options);
        this.store = new Oe(this.options.resources, this.options);
        const f = this.services;
        f.logger = F, f.resourceStore = this.store, f.languageUtils = c, f.pluralResolver = new bt(c, {
          prepend: this.options.pluralSeparator,
          simplifyPluralSuffix: this.options.simplifyPluralSuffix
        }), this.options.interpolation.format && this.options.interpolation.format !== n.interpolation.format && this.logger.deprecate("init: you are still using the legacy format function, please use the new approach: https://www.i18next.com/translation-function/formatting"), u && (!this.options.interpolation.format || this.options.interpolation.format === n.interpolation.format) && (f.formatter = i(u), f.formatter.init && f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new je(this.options), f.utils = {
          hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
        }, f.backendConnector = new Ot(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", (h, ...p) => {
          this.emit(h, ...p);
    ...
    dir(e) {
      ...
      const t = [
        ...
        "sam",
        "ckb"
      ], n = ((_b = this.services) == null ? void 0 : _b.languageUtils) || new Pe(Ee());
    ...
    cloneInstance(e = {}, t = te) {
      ...
      if ((e.debug !== void 0 || e.prefix !== void 0) && (r.logger = r.logger.clone(e)), [
        ...
        r.store = new Oe(a, i), r.services.resourceStore = r.store;
      }
      return e.interpolation && (r.services.interpolator = new je(i)), r.translator = new se(r.services, i), r.translator.on("*", (a, ...l) => {
        r.emit(a, ...l);
  ...
  const Pt = (s, e, t, n) => {
    ...
    U(t) && Te[t] || (U(t) && (Te[t] = /* @__PURE__ */ new Date()), Pt(s, e, t, n));
  }, Je = (s, e) => () => {
  ...
  }, Ct = (s, e, t = {}) => !e.languages || !e.languages.length ? (Xe(e, "NO_LANGUAGES", "i18n.languages were undefined or empty", {
  ...
  }), U = (s) => typeof s == "string", Rt = (s) => typeof s == "object" && s !== null, kt = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g, jt = {
    "&amp;": "&",
    "&#38;": "&",
    "&lt;": "<",
    "&#60;": "<",
  ...
  let At, Ht, Ut;
  At = (s, e) => U(e) ? e : Rt(e) && U(e.defaultValue) ? e.defaultValue : Array.isArray(s) ? s[s.length - 1] : s;
  Ht = {
    t: At,
    ready: false
  };
  ...
  vn = (s, e = {}) => {
    var _a, _b, _c;
    const { i18n: t } = e, { i18n: n, defaultNS: i } = P.useContext(Qe) || {}, r = t || n || It();
    r && !r.reportNamespaces && (r.reportNamespaces = new Dt()), r || Xe(r, "NO_I18NEXT_INSTANCE", "useTranslation: You will need to pass in an i18next instance by using initReactI18next");
    const o = P.useMemo(() => {
      var _a2;
      return {
        ...Tt(),
    ...
    const d = P.useRef(0), h = P.useCallback((y) => {
      ...
      if (!r) return Ht;
      const y = !!(r.isInitialized || r.initializedStoreOnce) && f.every((Z) => Ct(Z, r, o)), m = e.lng || r.language, v = d.current, w = p.current;
      if (w && w.ready === y && w.lng === m && w.keyPrefix === l && w.revision === v) return w;
      const k = {
      ...
      o,
      e.lng
    ]), [x, $] = P.useState(0), { t: S, ready: C } = nt.useSyncExternalStore(h, b, b);
    P.useEffect(() => {
      if (r && !C && !a) {
        const y = () => $((m) => m + 1);
        e.lng ? Fe(r, e.lng, f, y) : de(r, f, y);
      }
    }, [
      r,
      e.lng,
    ...
    const O = r || {}, R = P.useRef(null), N = P.useRef(), I = (y) => {
      const m = Object.getOwnPropertyDescriptors(y);
      m.__original && delete m.__original;
      const v = Object.create(Object.getPrototypeOf(y), m);
      ...
      let v = y;
      y && (R.current && R.current.__original === y ? N.current !== m ? (v = I(y), R.current = v, N.current = m) : v = R.current : (v = I(y), R.current = v, N.current = m));
      const w = [
        S,
        v,
        C
  ...
  if (!A && !Y && !re) try {
    rt(() => import("./browser-ponyfill-cbhNWhYU.js").then((s) => s.b), __vite__mapDeps([0,1])).then(function(s) {
      A = s.default;
    }).catch(function() {
    });
  } catch {

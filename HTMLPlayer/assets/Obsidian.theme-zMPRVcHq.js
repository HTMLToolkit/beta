...
:root {
  ...
  --themecolor-transparent: hsla(260, 30%, 40%, 0.5);
  ...
  --foreground-subtle: hsla(0, 0%, 80%, 0.7);
  ...
  --shadow-focus:
    0 0 0 2px hsla(260, 30%, 45%, 0.25), 0 1px 2px hsla(0, 0%, 0%, 0.05);
}
...
.dark {
  ...
  --themecolor3: hsla(260, 20%, 25%, 0.5);
  --themecolor4: hsl(260, 20%, 18%);
  --themecolor-transparent: hsla(260, 25%, 30%, 0.5);

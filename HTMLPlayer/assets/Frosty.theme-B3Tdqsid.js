...
:root {
  ...
  --themecolor-transparent: hsla(195, 85%, 85%, 0.5);
  ...
  --foreground-strong: hsl(210, 60%, 15%);
  --foreground-stronger: hsl(210, 70%, 10%);
  --foreground-muted: hsl(210, 40%, 40%);
  --foreground-subtle: hsl(210, 30%, 60%);
  ...
  --primary-foreground: hsl(210, 60%, 15%);
  /* Primary Transparent */
  ...
  --shadow:
    0 1px 2px hsla(190, 20%, 5%, 0.05), 0 3px 6px hsla(190, 20%, 5%, 0.07);
  --shadow-md:
    0 1px 3px hsla(190, 20%, 5%, 0.05),
  ...
  --shadow-focus:
    0 0 0 2px hsla(195, 85%, 85%, 0.25), 0 1px 2px hsla(190, 20%, 5%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(195, 60%, 40%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(190, 20%, 0%, 0.1), 0 3px 6px hsla(190, 20%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(190, 20%, 0%, 0.1), 0 10px 15px -5px hsla(190, 20%, 0%, 0.1),
    0 20px 25px -5px hsla(190, 20%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(190, 20%, 0%, 0.1),

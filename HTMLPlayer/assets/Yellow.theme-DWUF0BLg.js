...
:root {
  ...
  --themecolor-transparent: hsla(45, 90%, 40%, 0.5);
  ...
  --border: hsl(45, 20%, 90%);
  --shadow:
    0 1px 2px hsla(45, 15%, 5%, 0.05), 0 3px 6px hsla(45, 15%, 5%, 0.07);
  --shadow-md:
    0 1px 3px hsla(45, 15%, 5%, 0.05), 0 10px 15px -5px hsla(45, 15%, 5%, 0.05),
    0 20px 25px -5px hsla(45, 15%, 5%, 0.04);
  --shadow-lg:
    0 1px 3px hsla(45, 15%, 5%, 0.05), 0 20px 25px -5px hsla(45, 15%, 5%, 0.07),
    0 30px 40px -5px hsla(45, 15%, 5%, 0.05);
  --shadow-focus:
    0 0 0 2px hsla(45, 90%, 50%, 0.25), 0 1px 2px hsla(45, 15%, 5%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(45, 75%, 20%, 0.5);
  ...
  /* Shadows */
  --border: hsl(45, 55%, 20%);
  --shadow: 0 1px 2px hsla(45, 55%, 0%, 0.1), 0 3px 6px hsla(45, 55%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(45, 55%, 0%, 0.1), 0 10px 15px -5px hsla(45, 55%, 0%, 0.1),
    0 20px 25px -5px hsla(45, 55%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(45, 55%, 0%, 0.1), 0 20px 25px -5px hsla(45, 55%, 0%, 0.15),

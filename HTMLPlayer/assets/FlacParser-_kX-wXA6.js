import { A as R, U as o, S as k, h as E, D as m, t as v, j as U, m as A, r as g, g as p, u as N, k as I, f as w, L as M } from "./vendor-audio-DkF9nV6x.js";
import { A as _ } from "./AbstractID3Parser-3xbdiBE3.js";
class h {
  static fromBase64(t) {
  ...
  get(t, e) {
    ...
    return { type: r, format: i, description: T, width: P, height: C, colour_depth: L, indexed_color: b, data: O };
  }
}
const d = { len: 7, get: (a, t) => ({ packetType: E.get(a, t), vorbis: new k(6, "ascii").get(a, t + 1) }) }, x = { len: 23, get: (a, t) => ({ version: m.get(a, t + 0), channelMode: E.get(a, t + 4), sampleRate: m.get(a, t + 5), bitrateMax: m.get(a, t + 9), bitrateNominal: m.get(a, t + 13), bitrateMin: m.get(a, t + 17) }) };
class B {
  constructor(t, e) {
...
class u {
  ...
  parseFirstPage(t, e) {
    this.metadata.setFormat("codec", "Vorbis I"), this.metadata.setFormat("hasAudio", true), l("Parse first page");
    const r = d.get(e, 0);
  ...
  async parseFullPage(t) {
    const e = d.get(t, 0);
    if (l("Parse full page: type=%s, byteLength=%s", e.packetType, t.byteLength), e.packetType === 3) return this.parseUserCommentList(t, d.len);
  }
...
const c = { STREAMINFO: 0, PADDING: 1, APPLICATION: 2, SEEKTABLE: 3, VORBIS_COMMENT: 4, CUESHEET: 5, PICTURE: 6 }, D = { len: 4, get: (a, t) => ({ lastBlock: N(a, t, 7), type: p(a, t, 1, 7), length: g.get(a, t + 1) }) }, S = { len: 34, get: (a, t) => ({ minimumBlockSize: w.get(a, t), maximumBlockSize: w.get(a, t + 2) / 1e3, minimumFrameSize: g.get(a, t + 4), maximumFrameSize: g.get(a, t + 7), sampleRate: g.get(a, t + 10) >> 4, channels: p(a, t + 12, 4, 3) + 1, bitsPerSample: p(a, t + 12, 7, 5) + 1, totalSamples: p(a, t + 13, 4, 36), fileMD5: new I(16).get(a, t + 18) }) }, $ = U("music-metadata:parser:FLAC");

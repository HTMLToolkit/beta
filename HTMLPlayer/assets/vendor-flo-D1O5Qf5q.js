...
function _e() {
  ...
  return t.wbg = {}, t.wbg.__wbg_Error_52673b7de5a0ca89 = function(e, n) {
    ...
    const r = String(n), _ = M(r, o.__wbindgen_malloc, o.__wbindgen_realloc), c = w;
    ...
    const r = L(n), _ = M(r, o.__wbindgen_malloc, o.__wbindgen_realloc), c = w;
    f().setInt32(e + 4, c, true), f().setInt32(e + 0, _, true);
    ...
    var c = p(_) ? 0 : M(_, o.__wbindgen_malloc, o.__wbindgen_realloc), s = w;
    ...
    const r = n.stack, _ = M(r, o.__wbindgen_malloc, o.__wbindgen_realloc), c = w;
    f().setInt32(e + 4, c, true), f().setInt32(e + 0, _, true);
...
async function oe(t) {
  ...
  typeof t < "u" && (Object.getPrototypeOf(t) === Object.prototype ? { module_or_path: t } = t : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof t > "u" && (t = new URL("" + new URL("reflo_bg-DROH2Zqt.wasm", import.meta.url).href, import.meta.url));
  const e = _e();
...
function ye(t) {
  const e = U(t, i.__wbindgen_malloc), n = u, r = i.decode(e, n);
  if (r[3]) throw d(r[2]);
  var _ = H(r[0], r[1]).slice();
  return i.__wbindgen_free(r[0], r[1] * 4, 4), _;
}
function pe(t) {
  const e = U(t, i.__wbindgen_malloc), n = u, r = i.get_cover_art(e, n);
  if (r[2]) throw d(r[1]);
  return d(r[0]);
}
function me(t) {
  const e = U(t, i.__wbindgen_malloc), n = u, r = i.get_metadata(e, n);
  if (r[2]) throw d(r[1]);
  return d(r[0]);
}
function he(t) {
  const e = U(t, i.__wbindgen_malloc), n = u, r = i.get_synced_lyrics(e, n);
  if (r[2]) throw d(r[1]);
  return d(r[0]);
}
function Ae(t) {
  const e = U(t, i.__wbindgen_malloc), n = u, r = i.info(e, n);
  if (r[2]) throw d(r[1]);
  return T.__wrap(r[0]);
}
...
async function de(t) {
  ...
  typeof t < "u" && (Object.getPrototypeOf(t) === Object.prototype ? { module_or_path: t } = t : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof t > "u" && (t = new URL("" + new URL("libflo_audio_bg-B6Abkcq5.wasm", import.meta.url).href, import.meta.url));
  const e = ge();
  (typeof t == "string" || typeof Request == "function" && t instanceof Request || typeof URL == "function" && t instanceof URL) && (t = fetch(t));

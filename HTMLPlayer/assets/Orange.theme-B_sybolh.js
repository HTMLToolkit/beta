...
:root {
  ...
  --themecolor-transparent: hsla(35, 100%, 55%, 0.5);
  ...
  --border: hsl(30, 20%, 90%);
  --shadow:
    0 1px 2px hsla(30, 20%, 5%, 0.05), 0 3px 6px hsla(30, 20%, 5%, 0.07);
  --shadow-md:
    0 1px 3px hsla(30, 20%, 5%, 0.05), 0 10px 15px -5px hsla(30, 20%, 5%, 0.05),
    0 20px 25px -5px hsla(30, 20%, 5%, 0.04);
  --shadow-lg:
    0 1px 3px hsla(30, 20%, 5%, 0.05), 0 20px 25px -5px hsla(30, 20%, 5%, 0.07),
    0 30px 40px -5px hsla(30, 20%, 5%, 0.05);
  --shadow-focus:
    0 0 0 2px hsla(35, 100%, 55%, 0.25), 0 1px 2px hsla(30, 20%, 5%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(25, 65%, 25%, 0.5);
  ...
  /* Shadows */
  --border: hsl(25, 50%, 20%);
  --shadow: 0 1px 2px hsla(25, 50%, 0%, 0.1), 0 3px 6px hsla(25, 50%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(25, 50%, 0%, 0.1), 0 10px 15px -5px hsla(25, 50%, 0%, 0.1),
    0 20px 25px -5px hsla(25, 50%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(25, 50%, 0%, 0.1), 0 20px 25px -5px hsla(25, 50%, 0%, 0.15),

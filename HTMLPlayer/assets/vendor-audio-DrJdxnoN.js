const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MpegParser-Dsd8KW5d.js","assets/AbstractID3Parser-B9quUGST.js","assets/ID3v2Parser-DeLXj5Tz.js","assets/vendor-react-qkC6yhPU.js","assets/vendor-i18n-WLbSf5LT.js","assets/vendor-ui-WM1JXJ50.js","assets/vendor-uppy-CguFdeWP.js","assets/AsfParser-C20cpYcc.js","assets/DsdiffParser-4gArvP5l.js","assets/AiffParser-MOQQejt3.js","assets/DsfParser-CD3Co0r5.js","assets/FlacParser-Bp0pddSz.js","assets/MatroskaParser-CHI64wnw.js","assets/MP4Parser-D0bZhF84.js","assets/MusepackParser-D0XDZtVJ.js","assets/OggParser-B_fCZDAK.js","assets/WavPackParser-Day0umVF.js","assets/WaveParser-D0FWUB-_.js"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { g as Ke } from "./vendor-react-qkC6yhPU.js";
import { _ as S, __tla as __tla_0 } from "./vendor-i18n-WLbSf5LT.js";
let be, Ca, pt, tt, ba, I, ka, He, h, Lt, rt, T, F, U, $t, mt, we, Xt, Ut, b, Xi, ce, Vt, qt, Gt, va, it, Nt, La, ya, Wr, Bi, et, Oa, Ba, za, Pa, z, ct, N, Ea, V, at, Aa, Di, _a, ft, Ma, ve, Ge, Da, Sa, Gi, Fa, q, Ra, Ui, pe;
let __tla = Promise.all([
  ...
  function _t() {
    return Be || (Be = 1, Q.read = function(i, e, t, r, a) {
      var n, o, u = a * 8 - r - 1, d = (1 << u) - 1, m = d >> 1, c = -7, s = t ? a - 1 : 0, l = t ? -1 : 1, f = i[e + s];
      ...
      if (n === 0) n = 1 - m;
        ...
        o = o + Math.pow(2, r), n = n - m;
      }
      return (f ? -1 : 1) * o * Math.pow(2, n - r);
    }, Q.write = function(i, e, t, r, a, n) {
      var o, u, d, m = n * 8 - a - 1, c = (1 << m) - 1, s = c >> 1, l = a === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f = r ? 0 : n - 1, g = r ? 1 : -1, k = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
      ...
      for (o = o << a | u, m += a; m > 0; i[t + f] = o & 255, f += g, o /= 256, m -= 8) ;
      i[t + f - g] |= k * 128;
    }), Q;
  }
  var B = _t();
  ...
  function ei() {
    ...
    function d(c) {
      var s = Math.abs(c);
      return s >= r ? m(c, s, r, "day") : s >= t ? m(c, s, t, "hour") : s >= e ? m(c, s, e, "minute") : s >= i ? m(c, s, i, "second") : c + " ms";
    }
    function m(c, s, l, f) {
      var g = s >= l * 1.5;
  ...
  function ti() {
    ...
    Le = 1;
    function i(e) {
      r.debug = r, r.default = r, r.coerce = m, r.disable = u, r.enable = n, r.enabled = d, r.humanize = ei(), r.destroy = c, Object.keys(e).forEach((s) => {
        r[s] = e[s];
      ...
      function r(s) {
        ...
        function y(...w) {
          ...
          let J = 0;
          w[0] = w[0].replace(/%([a-zA-Z%])/g, (me, gt) => {
            if (me === "%%") return "%";
            J++;
            const Me = r.formatters[gt];
            if (typeof Me == "function") {
              const Tt = w[J];
              me = Me.call(v, Tt), w.splice(J, 1), J--;
            }
            return me;
  ...
  function ii() {
    return Oe || (Oe = 1, (function(i, e) {
      ...
      e.formatArgs = a, e.save = n, e.load = o, e.useColors = r, e.storage = u(), e.destroy = /* @__PURE__ */ (() => {
        let m = false;
        return () => {
          m || (m = true, console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."));
        };
      })(), e.colors = [
        "#0000CC",
        "#0000FF",
      ...
      function a(m) {
        if (m[0] = (this.useColors ? "%c" : "") + this.namespace + (this.useColors ? " %c" : " ") + m[0] + (this.useColors ? "%c " : " ") + "+" + i.exports.humanize(this.diff), !this.useColors) return;
      ...
      function o() {
        let m;
        try {
          m = e.storage.getItem("debug") || e.storage.getItem("DEBUG");
        } catch {
        }
        return !m && typeof process < "u" && "env" in process && (m = t.DEBUG), m;
      }
      function u() {
        try {
          return localStorage;
        ...
        if (await this.tokenizer.ignore(a.extraFieldLength), a.dataDescriptor && a.compressedSize === 0) {
          ...
          for (; m < 0 && d === xe; ) {
            d = await this.tokenizer.peekBuffer(this.syncBuffer, {
              mayBeLess: true
            }), m = ci(this.syncBuffer.subarray(0, d), oi);
            const c = m >= 0 ? m : d;
            if (n.handler) {
  ...
  const pi = Object.prototype.toString, mi = "[object Uint8Array]";
  function di(i, e, t) {
    return i ? i.constructor === e ? true : pi.call(i) === t : false;
  }
  function fi(i) {
    return di(i, Uint8Array, mi);
  }
  function xi(i) {
      ...
      __publicField(this, "detectConfident", async (e) => {
        ...
        if (this.check([
          ...
          async function t() {
            ...
            let d = 128, m = 0;
            for (; (u & d) === 0 && d !== 0; ) ++m, d >>= 1;
            const c = new Uint8Array(m + 1);
            return await e.readBuffer(c), c;
          }
          async function r() {
            const u = await t(), d = await t();
            d[0] ^= 128 >> d.length - 1;
            const m = Math.min(6, d.length), c = new DataView(u.buffer), s = new DataView(d.buffer, d.length - m, m);
            return {
              id: ke(c),
              len: ke(s)
            };
...
`, {
    ...
    async toDetectionStream(e, t) {
      ...
      try {
        const { value: m, done: c } = await o.read(new Uint8Array(r));
        if (n = m, !c && m) try {
          a = await this.fromBuffer(m.subarray(0, r));
        } catch (s) {
  ...
  function Si() {
    ...
    function n(u) {
      ...
      var m = d[1], c = d[2], s, l = c.lastIndexOf("+");
      return l !== -1 && (s = c.substr(l + 1), c = c.substr(0, l)), new o(m, c, s);
    }
    function o(u, d, m) {
      this.type = u, this.subtype = d, this.suffix = m;
    }
    return j;
  }
  var Ci = Si();
...
`), t = [];
    for (const r of e) {
      const a = r.match(Ie);
      if (a) {
        const n = Number.parseInt(a[1], 10), o = Number.parseInt(a[2], 10), u = a[3].length === 3 ? Number.parseInt(a[3], 10) : Number.parseInt(a[3], 10) * 10, d = (n * 60 + o) * 1e3 + u, m = r.replace(Ie, "").trim();
        t.push({
          timestamp: d,
          text: m
        });
...
`),
  ...
  const L = V("music-metadata:collector"), mr = [
    "matroska",
    "APEv2",
    "vorbis",
    "ID3v2.4",
  ...
  class dr {
    constructor(e) {
      ...
      let t = 1;
      for (const r of mr) this.originPriority[r] = t++;
  ...
  const xr = {
    ...
    async load() {
      return (await S(async () => {
        const { MpegParser: i } = await import("./MpegParser-Dsd8KW5d.js");
        return {
          MpegParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { AsfParser: i } = await import("./AsfParser-C20cpYcc.js");
        return {
          AsfParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { DsdiffParser: i } = await import("./DsdiffParser-4gArvP5l.js");
        return {
          DsdiffParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { AIFFParser: i } = await import("./AiffParser-MOQQejt3.js");
        return {
          AIFFParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { DsfParser: i } = await import("./DsfParser-CD3Co0r5.js");
        return {
          DsfParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { FlacParser: i } = await import("./FlacParser-Bp0pddSz.js").then((e) => e.d);
        return {
          FlacParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { MatroskaParser: i } = await import("./MatroskaParser-CHI64wnw.js");
        return {
          MatroskaParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { MP4Parser: i } = await import("./MP4Parser-D0bZhF84.js");
        return {
          MP4Parser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { MusepackParser: i } = await import("./MusepackParser-D0XDZtVJ.js");
        return {
          MusepackParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { OggParser: i } = await import("./OggParser-B_fCZDAK.js");
        return {
          OggParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { WavPackParser: i } = await import("./WavPackParser-Day0umVF.js");
        return {
          WavPackParser: i
        };
    ...
    async load() {
      return (await S(async () => {
        const { WaveParser: i } = await import("./WaveParser-D0FWUB-_.js");
        return {
          WaveParser: i
        };
  ...
  mt = {
    len: 4,
    get: (i, e) => {
      const t = pe(i.subarray(e, e + mt.len), "latin1");
    ...
    async parseTags(e) {
      ...
      for (let a = 0; a < e.fields; a++) {
        ...
        switch (await this.tokenizer.ignore(1), r -= u.length + 1, n.flags.dataType) {
          case re.text_utf8: {
            const m = (await this.tokenizer.readToken(new b(n.size, "utf8"))).split(/\x00/g);
            await Promise.all(m.map((c) => this.metadata.addTag(je, u, c)));
            break;
          }
          case re.binary:
            if (this.options.skipCovers) await this.tokenizer.ignore(n.size);
              ...
              const m = pe(d.subarray(0, o), "utf-8"), c = d.subarray(o + 1);
  ...
  async function qr(i) {
    if (i.fileInfo.size >= 128) {
      ...
      }), i.setPosition(t), pe(e, "latin1") === "TAG";
    }
    return false;
  }
  const Hr = "LYRICS200";

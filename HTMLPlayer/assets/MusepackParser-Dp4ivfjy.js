import { S as w, j as m, h as F, D as i, g as r, i as d, m as L, B as y, L as P, a0 as S, H as n, t as x } from "./vendor-audio-DkF9nV6x.js";
import { A as v } from "./AbstractID3Parser-3xbdiBE3.js";
...
const l = m("music-metadata:parser:musepack:sv8"), C = new w(2, "latin1"), u = { len: 5, get: (a, e) => ({ crc: i.get(a, e), streamVersion: F.get(a, e + 4) }) }, p = { len: 2, get: (a, e) => ({ sampleFrequency: [44100, 48e3, 37800, 32e3][r(a, e, 0, 3)], maxUsedBands: r(a, e, 3, 5), channelCount: r(a, e + 1, 0, 4) + 1, msUsed: d(a, e + 1, 4), audioBlockFrames: r(a, e + 1, 5, 3) }) };
class M {
  get tokenizer() {
  ...
  async readVariableSizeField(e = 1, t = 0) {
    ...
    return (s & 128) === 0 ? { len: e, value: t + s } : (s &= 127, s += t, this.readVariableSizeField(e + 1, s << 7));
  }
}
...
const b = { len: 24, get: (a, e) => {
  const t = { signature: x(a.subarray(e, e + 3), "latin1"), streamMinorVersion: r(a, e + 3, 0, 4), streamMajorVersion: r(a, e + 3, 4, 4), frameCount: i.get(a, e + 4), maxLevel: n.get(a, e + 8), sampleFrequency: [44100, 48e3, 37800, 32e3][r(a, e + 10, 0, 2)], link: r(a, e + 10, 2, 2), profile: r(a, e + 10, 4, 4), maxBand: r(a, e + 11, 0, 6), intensityStereo: d(a, e + 11, 6), midSideStereo: d(a, e + 11, 7), titlePeak: n.get(a, e + 12), titleGain: n.get(a, e + 14), albumPeak: n.get(a, e + 16), albumGain: n.get(a, e + 18), lastFrameLength: i.get(a, e + 20) >>> 20 & 2047, trueGapless: d(a, e + 23, 0) };
...
class O extends y {
  ...
  async parse() {
    ...
    this.metadata.setFormat("numberOfSamples", t), this.duration = t / e.sampleFrequency, this.metadata.setFormat("duration", this.duration), this.bitreader = new H(this.tokenizer), this.metadata.setFormat("numberOfChannels", e.midSideStereo || e.intensityStereo ? 2 : 1);

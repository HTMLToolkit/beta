...
:root {
  ...
  --themecolor-transparent: hsla(262, 83%, 58%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(262, 15%, 5%, 0.05), 0 3px 6px hsla(262, 15%, 5%, 0.07);
  --shadow-md:
    0 1px 3px hsla(262, 15%, 5%, 0.05),
  ...
  --shadow-focus:
    0 0 0 2px hsla(262, 83%, 58%, 0.25), 0 1px 2px hsla(262, 15%, 5%, 0.05);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(262, 83%, 45%, 0.5);
  ...
  --shadow:
    0 1px 2px hsla(262, 25%, 0%, 0.1), 0 3px 6px hsla(262, 25%, 0%, 0.15);
  --shadow-md:
    0 1px 3px hsla(262, 25%, 0%, 0.1), 0 10px 15px -5px hsla(262, 25%, 0%, 0.1),
    0 20px 25px -5px hsla(262, 25%, 0%, 0.08);
  --shadow-lg:
    0 1px 3px hsla(262, 25%, 0%, 0.1),

...
:root {
  ...
  --border: hsl(40, 20%, 85%);
  --shadow:
    0 1px 2px hsla(16, 100%, 50%, 0.08), 0 3px 6px hsla(38, 100%, 50%, 0.1);
  --shadow-md:
    0 1px 3px hsla(16, 100%, 50%, 0.08),
  ...
  --shadow-focus:
    0 0 0 2px hsla(16, 100%, 50%, 0.3), 0 0 8px hsla(45, 100%, 50%, 0.2);
}
...
.dark {
  ...
  --themecolor-transparent: hsla(16, 100%, 65%, 0.5);
  ...
  --border: hsl(20, 20%, 16%);
  --shadow:
    0 1px 2px hsla(16, 100%, 65%, 0.15), 0 3px 6px hsla(38, 100%, 65%, 0.2);
  --shadow-md:
    0 1px 3px hsla(16, 100%, 65%, 0.15),

import { B as t, n as a, E as r, j as i, o as n } from "./vendor-audio-CPMNR9Qe.js";
import { I as o } from "./ID3v2Parser-DcVpOGw0.js";
...
class I extends t {
  ...
  async tryReadId3v2Headers() {
    if ((await this.tokenizer.peekToken(a)).fileIdentifier === "ID3") return s("Found ID3v2 header, pos=%s", this.tokenizer.position), await this.id3parser.parse(this.metadata, this.tokenizer, this.options), this.tryReadId3v2Headers();
  }
}
export {
  I as A
